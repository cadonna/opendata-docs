...
<Note>
  Timeseries implements this pattern for OpenTelemetry metrics by leveraging [`opendata` Ingest](/ingest/index)
  via the `opendata` OTel Collector exporter and an in-server ingest consumer. See
